...
class MessageController extends Controller
{
    ...
    public function saveConfirm($message, $location, $id, $confirm_id){
        return $this->confirmModal('Konfirmasi Perubahan','Apakah anda yakin kembali sebelum menyimpan perubahan pada data '.$message.'?', $id, '<button type="button" class="btn btn-warning" id="'.$confirm_id.'">Simpan</button>', '<a href="'.$location.'" class="btn btn-secondary">Kembali</a>');
    }
