...
@section('content')                         
<div class="col-md-12">
  <h2 class="mt-3 fw-bold" style="color: #000; margin-bottom: 20px;">Edit User</h2>
  <div class="custom-card">                  
    <div class="custom-card-header text-clear">
      <h4 class="text-center">Formulir Edit Pengguna</h4>                    
    </div>               
    @if ($errors->any())
        ...
        <div class="container-fluid">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#reset_password">Reset Password</button>
            </div>                    
          </div>                                                       
        </div>                                                                           
        <div class="footer-card-btn">                
          <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#confirm_modal">Kembali</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">            
      ...
      <div class="modal-footer">                               
        ...
        <button type="button" class="btn btn-warning" id="save_password">Simpan</button>
      </div>
    </div>
  </div>
</div>      
