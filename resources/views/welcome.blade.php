...
<head>
    ...
    <style>
        ...
        .bg-dark{--bg-opacity:1;background-color:#000;}
        .bg-dark-100{--bg-opacity:1;background-color:#000;}
        .border-dark-200{--border-opacity:1;border-color:#000;}
        ...
        @media (min-width:640px){
            ...
            @media (min-width:768px){
                ...
                @media (min-width:1024px){
                    ...
                    <style>
                        body {
                            ...
                            background-image:url("https://images.unsplash.com/photo-1480239435007-433849a15a9a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80");
                            width:100%;
                ...
                <body class="antialiased bg-dark">
                    <h1 class="logo">Karta</h1>
                    <h3 class="logo1">Jaya Haji Gopur</h3>
                    <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0 kotak2">
                        ...
                        <div class="mt-8 overflow-hidden sm:rounded-lg">
                            <div class="kotakkonten">
                                <div class="p-6 text-light">
                                    <h1 class="text">Ayo Buat Rancangan Anggaran Biaya Kegiatanmu dengan Mudah dan Cepat</h1>

                                    <button type="button" class="btn tombol">
                                        @if (Route::has('login'))
                                        <div>
                                            @auth
                                            <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Kembai ke Dashboard</a>
                                            @else
                                            <a href="{{ route('login') }}" class="text-sm btn warna1">Log in</a>
                                            @endauth
                                        </div>
                                        @endif
                                    </button>  
